...
const compostables = [
    ...
    { name: "Fruit abîmé", types: ["composteur", "lombricomposteur"] },
    { name: "Légume abîmé", types: ["composteur", "lombricomposteur"] },
...
var close = document.getElementsByClassName("close-memo");
var i;
...
function newElement() {
  ...
  var inputValue = document.getElementById("note-list").value;
