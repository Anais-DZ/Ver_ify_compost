...
const tabDechet = [
    ...
    { name: "Nectarine (sans le noyau)", types: "composteur, lombricomposteur" },
    ...
    { name: "Pêche (sans le noyau)", types: "composteur, lombricomposteur" },
    { name: "Petits pois", types: "composteur, lombricomposteur" },
    ...
    { name: "Prune (sans le noyau)", types: "composteur, lombricomposteur" },
